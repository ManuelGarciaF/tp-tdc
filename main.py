...
tiempo_paso_simulacion = 500  # ms, tiempo para graficar cada ciclo

# Configurables mediante casillas de texto
params = {
    "tam buffer rx": 6400,           # Bytes, determina el error superior
    ...
    "limite bytes perturbados": 1024,  # El número de bytes perdidos va entre 0 y este número
}
